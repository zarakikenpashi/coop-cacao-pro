...
const nav = [
  ...
  // 🛒 ACHATS
  {
    section: 'Achats cacao',
    items: [
      {
        label: "Dossiers d'achat",
        to: '/app/achats',
        icon: 'file-text',
        children: [
          { label: 'Nouvel achat', to: '/app/achats/new' },
          { label: 'Liste des achats', to: '/app/achats/list' },
        ],
      },
    ],
  },
  ...
  // 👨‍🌾 FOURNISSEURS = PRODUCTEURS
  {
    ...
    items: [
      {
        label: 'Fournisseurs cacao',
        to: '/app/producteurs',
        icon: 'users',
        children: [
          { label: 'Liste producteurs', to: '/app/producteurs/list' },
          { label: 'Ajouter producteur', to: '/app/producteurs/new' },
          { label: 'Historique des ventes', to: '/app/producteurs/history' },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        icon: 'list',
        children: [
          { label: 'Créer un lot', to: '/app/lots/new' },
          { label: 'Suivi des lots', to: '/app/lots/list' },
        ],
      },
    ],
  },
  ...
  // 💰 PAIEMENTS
  {
    ...
    items: [
      {
        label: 'Paiements producteurs',
        to: '/app/paiements',
        icon: 'briefcase',
        children: [
          { label: 'Payer un producteur', to: '/app/paiements/new' },
          { label: 'Historique paiements', to: '/app/paiements/list' },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        icon: 'table',
        children: [
          { label: 'Achats', to: '/app/rapports/achats' },
          { label: 'Production', to: '/app/rapports/production' },
          { label: 'Finances', to: '/app/rapports/finances' },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        icon: 'user',
        children: [
          { label: 'Nouveau utilisateur', to: '/app/users/new' },
          { label: 'Liste utilisateurs', to: '/app/users/list' },
      ...
      },
      {
        ...
        icon: 'settings',
        children: [
          { label: 'Prix du cacao', to: '/app/settings/prix' },
          { label: 'Zones & sections', to: '/app/settings/zones' },
          { label: 'Sociétés', to: '/app/settings/societes' },
        ],
      },
    ],
  },
